      ...
      <div className="asd_body">
        ...
        <div className="asd_body_inner">
          ...
          <div className='ab_se'>
            ...
            <Link href="add-service"><h5 style={{ color: '#CD8A1A' }}><span><PiPencilSimpleLineBold /></span>Edit details</h5></Link>
          </div>
          ...
          <ul className='ab_ul'>
            <li><strong style={{ color: '#FFFF' }}>Consultation and Skin Analysis</strong> - The service begins with a professional consultation to assess your skin's condition and determine the appropriate depth and technique for microneedling.</li>
            <li><strong style={{ color: '#FFFF' }}>Cleansing and Numbing</strong> - Your skin is thoroughly cleansed to remove any impurities. A topical numbing cream is applied to ensure a comfortable experience during the procedure.</li>
            <li><strong style={{ color: '#FFFF' }}>Consultation and Skin Analysis</strong> - The service begins with a professional consultation to assess your skin's condition and determine the appropriate depth and technique for microneedling.</li>
            <li><strong style={{ color: '#FFFF' }}>Consultation and Skin Analysis</strong> - The service begins with a professional consultation to assess your skin's condition and determine the appropriate depth and technique for microneedling.</li>
            <li><strong style={{ color: '#FFFF' }}>Cleansing and Numbing</strong> - Your skin is thoroughly cleansed to remove any impurities. A topical numbing cream is applied to ensure a comfortable experience during the procedure.</li>
          </ul>
