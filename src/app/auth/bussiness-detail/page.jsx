            ...
            <div className="auth_container bussiness">
                ...
                <div className='w-100'>
                    <form>
                        ...
                        <div className="row avail_serv pt-3 gy-3 justify-content-center">
                            <div className="col-12 pb-4">
                                <h4>Available Services </h4>
                            </div>
                            <div className="col-6 col-sm-3">
                                <Link className='d-inline-block' href="hair-services">
                                    <div className="as_item">
                                        <Image
                                            src="/images/asi_img1.svg"
                                            width={75}
                                            height={79}
                                            className="pb-icon"
                                            alt="Frame"
